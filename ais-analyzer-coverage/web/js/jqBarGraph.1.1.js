...
//		fieldWidth=1000;
		...
		var accumulatedWidth = 0;
 		...
 		for(var val in data){
			...
			var uniqueWidth = data[val][3];
			if(uniqueWidth < 1){ uniqueWidth = 1; }
			...
			// if there is no legend or exist legends display lbl at the bottom
 			if(!arr.legend || arr.legends)
 				out += "<div class='graphLabel"+el.id+"' id='graphLabel"+unique+"' style='height:200px'>"+lbl+"</div>";
 			out += "</div>";
