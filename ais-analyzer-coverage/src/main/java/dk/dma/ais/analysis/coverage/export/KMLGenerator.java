...
//	public static void generateKML(Collection<BaseStation> grids, double latSize, double lonSize, Response response) {
//
//		
//		
//		
...
////	}
//	
//	private static void writeLine(String line, Response out){
//		try{
...
//	
//	private static void generateGrid(String bsMmsi, Collection<Cell> cells,
//			Response out, double latSize, double lonSize) {
//
//			writeLine("<Folder>", out);
//			writeLine("<name>" + bsMmsi + "</name>", out);
